...
class ContactAdapter: ATCGenericCollectionRowAdapter {
    ...
    func configure(cell: UICollectionViewCell, with object: ATCGenericBaseModel) {
        guard let viewModel = object as? ATCUser, let cell = cell as? ATCThreadCollectionViewCell else { return }
        let theOtherUser = viewModel
